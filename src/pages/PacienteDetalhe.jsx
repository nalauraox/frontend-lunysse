...
import { ChevronLeft, Users, Mail, Phone, Calendar, Activity, CheckCircle, Clock, Eye, Plus } from 'lucide-react';
...
const Header = ({ onBack, title }) => (
  <div className="flex items-center gap-4">
    <button
      onClick={onBack}
      className="flex items-center gap-2 text-white cursor-pointer font-extrabold hover:text-indigo-200 px-4 py-2 rounded-lg transition-colors duration-300"
    >
        ...
        <div key={session.id} className="bg-white/50 rounded-lg border border-white/20 p-4">
          <div className="flex justify-between items-start">
            ...
            <button
              ...
              className="p-2 text-dark cursor-pointer hover:text-accent transition-colors"
